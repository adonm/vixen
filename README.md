...
Install the native Linux packages and bootstrap Mise directly on the host so
local checks match the repository's explicit Ubuntu 24.04 host jobs. Debian,
