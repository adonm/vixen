...
pub(crate) struct AccessibilityElement {
    ...
    pub aria_value_min: Option<String>,
    pub aria_value_max: Option<String>,
        ...
        for idx in 0..scan_len {
            ...
            for attr in attrs.iter() {
                ...
                match attr_name {
                    ...
                    "inputmode" => copy_accessibility_attr(
                        &mut element.input_mode,
                        attr.value.as_ref(),
                        max_string_bytes,
                        &mut truncated,
                    ),
                    "enterkeyhint" => copy_accessibility_attr(
                        &mut element.enter_key_hint,
                        attr.value.as_ref(),
                        max_string_bytes,
                        &mut truncated,
                    ),
                    ...
                    "aria-valuenow" => copy_accessibility_attr(
                        &mut element.aria_value_now,
                        attr.value.as_ref(),
                        max_string_bytes,
                        &mut truncated,
                    ),
                    "aria-valuemin" => copy_accessibility_attr(
                        &mut element.aria_value_min,
                        attr.value.as_ref(),
                        max_string_bytes,
                        &mut truncated,
                    ),
                    "aria-valuemax" => copy_accessibility_attr(
                        &mut element.aria_value_max,
                        attr.value.as_ref(),
                        max_string_bytes,
                        &mut truncated,
                    ),
                    "aria-valuetext" => copy_accessibility_attr(
                        &mut element.aria_value_text,
                        attr.value.as_ref(),
                        max_string_bytes,
                        &mut truncated,
                    ),
                    "aria-orientation" => copy_accessibility_attr(
                        &mut element.aria_orientation,
                        attr.value.as_ref(),
                        max_string_bytes,
                        &mut truncated,
                    ),
