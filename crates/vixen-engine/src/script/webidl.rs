...
const WEBIDL_INTERFACES: &[WebIdlInterface] = &[
    ...
    iface!("HTMLMediaElement" => "HTMLElement"; attrs ["src", "currentSrc", "networkState", "readyState", "currentTime", "duration", "paused", "ended", "autoplay", "loop", "controls", "muted", "volume", "preload", "crossOrigin"]; ops ["load", "play", "pause", "canPlayType"]),
    ...
    iface!("Range"; attrs ["startContainer", "startOffset", "endContainer", "endOffset", "collapsed", "commonAncestorContainer"]; ops ["setStart", "setEnd", "collapse", "selectNode", "selectNodeContents", "deleteContents", "extractContents", "cloneContents", "insertNode", "surroundContents", "cloneRange", "detach", "isPointInRange", "comparePoint", "intersectsNode", "toString"]),
    ...
    iface!("Navigator"; attrs ["userAgent", "language", "languages", "onLine", "cookieEnabled", "hardwareConcurrency", "maxTouchPoints", "storage", "clipboard", "serviceWorker", "geolocation", "mediaDevices"]; ops ["sendBeacon", "share", "canShare", "vibrate", "getBattery", "registerProtocolHandler"]),
