...
directives, and simultaneous exact `Vary` variants.
...
buffer-before-resolution stream as online consumption. Then add redirect
aliases. Keep direct classic/automation
