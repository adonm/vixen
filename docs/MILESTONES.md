...
| `just linux-release-smoke` | pinned x86_64 Flutter `3.47.1`/Dart 3.13 GTK3 release/AOT plus Rust bridge build; stripped ELFs, deterministic archive creation, clean extraction, and Impeller-aware Cage/headless-Wayland launch smoke |
