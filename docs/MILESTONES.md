...
- `just gate-native-abi` proves the handwritten C ABI/header/wire/frame ownership
  ...
  non-tree relationships, and native/authored range actions, but not IME, complete semantics/native
