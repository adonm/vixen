...
|-------|-----------------|
| [`mise.md`](mise.md) | Activating the project-managed Rust/Cargo/just toolchain correctly. Start here for local setup. |
| [`cargo-home.md`](cargo-home.md) | Why `CARGO_HOME` points at `<workspace>/.cargo` and how to refresh tooling installed via `cargo-binstall`. |
